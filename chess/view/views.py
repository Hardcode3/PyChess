    ...
    def __init__(self, display: pygame.Surface) -> None:
        ...
        self.add_entity(
            Label(Settings.WINDOW_SIZE / 2,
                  ...
                  "Chess"))
        self.add_entity(
            PushButton(Settings.WINDOW_SIZE / 2,
...
class SaveMenu(Menu):
    def __init__(self, display: pygame.Surface) -> None:
        ...
        self.add_entity(
            PushButton(Settings.WINDOW_SIZE * .45,
                       Settings.WINDOW_SIZE * .3,
                       Fonts.COMIC_SANS_MS,
                       35,
                       "load",
                       ...
                       Colors.GREEN))
        self.add_entity(
            PushButton(Settings.WINDOW_SIZE * .75,
                       Settings.WINDOW_SIZE * .3,
                       Fonts.COMIC_SANS_MS,
                       35,
                       "overwrite",
